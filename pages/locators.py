...
class BasePictureLocators:
    ...
    SEARCH_INPUT_FIELD = (By.XPATH, '/html/body/header/div/div[1]/div[2]/form/div[1]/span/span/input')
    ...
    PAGE_LINK = (By.XPATH, '/html/body/div[12]/div[2]/div/div/div/div[3]/div/div[3]/div/div/div[1]/div[4]/div[1]/a')
    FRAME = (By.XPATH, '/html/body/header/div/div[1]/div[2]/form/div[1]/span/span/button')
